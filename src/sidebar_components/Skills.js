...
import nodeImg from '../images/skills/languages/node-js.png'
...
import kafkaImg from '../images/skills/backend/kafka-logo.png'
...
import azureImg from '../images/skills/buildtools/Azure.png'
...
const LANGUAGES_MAP = new Map([
    ['Java', javaImg], ['NodeJS',nodeImg], ['JavaScript', jsImg], ['TypeScript', tsImg], ['Python', pythonImg], ['Shell Script', shellScriptImg]
]);

const FRONTEND_MAP = new Map([
    ['HTML', htmlImg], ['CSS', cssImg], ['React', reactImg],['Bootstrap', bootstrapImg], ['Material UI', materialUIImg],
    ['Materialize', materializeImg],
]);

const BACKEND_MAP = new Map([
    ['Spring', springImg], ['Spring Boot', springbootImg],
    ['Kafka', kafkaImg], ['MySQL', mysqlImg],
    ['MongoDB', mongodbImg], ['Redis', redisImg]
]);

const BUILD_TOOLS_MAP = new Map([
    ['Docker', dockerImg], ['Heroku', herokuImg], ['Microsoft Azure', azureImg],
